...
/* From https://wgropp.cs.illinois.edu/courses/cs598-s15/
        https://wgropp.cs.illinois.edu/courses/cs598-s15/examples/ioda.c
*/

#define MYSCRATCHDIR "/scratch/support_root/support/bennet/tmp"
